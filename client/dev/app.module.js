...
var PersonCmp_1 = require("./person/components/PersonCmp");
var todo_route_1 = require("./todo/components/todo-route");
var person_route_1 = require("./person/components/person-route");
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [
            ...
            person_route_1.personRouting
        ],
        declarations: [
            app_1.App,
            todo_cmp_1.TodoCmp,
            PersonCmp_1.PersonCmp
        ],
        providers: [
